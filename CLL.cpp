...
#include<stdlib.h>
	...
	void middleinsert()
	{
		...
		void disp()
		{
			if(start==NULL)
			{
		printf("\nNo elements in Linked List_______________________");
			}
			else
			{
		printf("\n\t\tLinked List elements are_______________________");
				t1=start;
				while(t1->link!=start)
				{
					printf(" %d",t1->data);
	...
	int main()
	{
		...
		while(1)
		{
			printf("\n\t\t\t_______________________Linked List Operations_______________________");
			printf("\n\n\t\t1. First Insert");
			printf("\n\n\t\t2. Last Insert");
			printf("\n\n\t\t3. Middle Insert");
			printf("\n\n\t\t4. First Delete");
			...
			printf("\n\n\t\t7. display");
			printf("\n\n\n\n\t\t8.Exit");
			printf("\n\n\tEnter your Choice_______________________");
			scanf("%d",&ch);
			switch(ch)
			{
